...
<div class="card">
    <div class="card-body">
        ...
        <div class="activity-item" style="padding: 15px; border-bottom: 1px solid #f5f5f5; background: <?php echo $notif['is_read'] ? 'transparent' : '#FFF5F5'; ?>; border-radius: var(--radius); margin-bottom: 5px;">
            ...
            <div class="activity-content" style="flex: 1;">
                ...
                <div style="font-size: 11px; color: #999; margin-top: 5px;"><?php echo date('M d, Y h:i A', strtotime($notif['created_at'])); ?> &bull; <?php echo $notif['is_read'] ? 'Read' : '<strong style="color: var(--kbmc-red);">Unread</strong>'; ?></div>
            </div>
        </div>
        <?php endforeach; ?>
        <?php endif; ?>
