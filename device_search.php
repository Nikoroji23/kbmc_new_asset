...
<div class="page-header">
    ...
    <p style="color: #7f8c8d; margin-top: 5px;">Find devices by serial number or asset tag</p>
</div>

<div class="card">
    <div class="card-body">
        <form method="POST" style="display: flex; gap: 10px; margin-bottom: 20px;">
            <input type="text" name="search_term" placeholder="Enter serial # or asset tag..." 
